...
const Projects = () => {
    return (
        ...
        <section className="projects-container">
            ...
            <Card title="Go Clean - Frontend" tech='React, Axios, React Router DOM, Sass' info='Interfaz web responsiva desarrollada en React para la gestión de usuarios y prestadores de servicios de limpieza. Incluye diseño adaptable, navegación fluida entre vistas, manejo eficiente de estados y una experiencia de usuario intuitiva.' img='GoClean' link='https://github.com/tonguiino/GoClean' />
        </section>
