...
import cvSantiago from "../../assets/pdf/cv_santiago_tonguino.pdf"
...
const Home = () => {
    ...
    link.href = cvSantiago;
    link.download = 'CV_Santiago_Tonguino.pdf';
        ...
        <section className="home" id="home" ref={homeRef}>
            ...
            <div className="profile-info">
                ...
                <div className="prodfile-info-button animado">
                   <button onClick={handleDownload} >Conoce mi CV</button>
